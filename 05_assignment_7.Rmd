...
gapminder_flu %>%
  ggplot(aes(x=continent,y=normalized_flu, group=continent, fill=continent)) + 
...
gapminder_dengue %>%
  ggplot(aes(x=continent,y=normalized_dengue, group=continent, fill=continent)) + 
  geom_col(stat="identity")+ 
