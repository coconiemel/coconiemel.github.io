...
The information is obtained by the following R and SQL code:
...
<img src="images/SQL_....jpg"
     width="300" 
     height="600" />
     
Figure 3: SQL code of left-join.

The analysis is done by despriptive statistics. First is the Shapiro-wilk to check for normal data, this was ... the case. The next step is an ANOVA, because we deal with 3 sets, this lead to ... . Finally the post-hoc tests, which concluded that ... .
