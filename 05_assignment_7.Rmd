...
Dengue has no "NULL" variables in country and year, there are 6263 cases in the data set and the average amount of cases is 0.14. The country with the least amount of cases is Argentina and the country with the most is Venezuela.
The Flu has no "NULL" variables in country and year, there are 17266 cases in the data set and the average amount of cases is 8.74. The country with the least amount of cases is Argentina and the country with the most is Uruguay.
