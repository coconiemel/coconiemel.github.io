...
<ul><li> How to add the genetic distances to the tree so it is clear in one view.</i>
<i> How to generate different types of trees, because there are a lot more and for different data, different types of trees are more compatible.</>
<i> How to read an extensive tree. The one I've created is doable, but once they get a lot more species, reading it becomes quite hard.</li></ul>