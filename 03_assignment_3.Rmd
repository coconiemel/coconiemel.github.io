...
Figure 3: Phylogenetic tree of the Filoviridae family.

```{r details}
# Details

filoviridae_dist_rounded
min(filoviridae_dist_rounded) # closest relative 0.56 TFe & BBe
max(filoviridae_dist_rounded) # furthest relavtive 0.76 BBe & Mm, BBe & Md, Se & Mm, Se & Md, Re & Mm, Lv & Mm, Lv & Md
